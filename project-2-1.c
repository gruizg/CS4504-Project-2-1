...
//2, how to sum up the total number of substring from all threads
    ...
    int thrdPartSize = n1 / NUM_THREADS;
    int thrdStartPoint = t * thrdPartSize;
    int thrdEndPoint = (t + 1) * thrdPartSize - 1;
    
    int thrdCounter = 0;
    
    for(int i = thrdStartPoint; i <= thrdEndPoint; i++){
